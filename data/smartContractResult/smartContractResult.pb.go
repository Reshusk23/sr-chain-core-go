...
import (
	...
	github_com_Reshusk23_sr_chain_core_go_data_vm "github.com/Reshusk23/sr-chain-core-go/data/vm"
...
type SmartContractResult struct {
	...
	Value          *math_big.Int                                          `protobuf:"bytes,2,opt,name=Value,proto3,casttypewith=math/big.Int;github.com/Reshusk23/sr-chain-core-go/data.BigIntCaster" json:"value"`
	...
	RelayedValue   *math_big.Int                                          `protobuf:"bytes,6,opt,name=RelayedValue,proto3,casttypewith=math/big.Int;github.com/Reshusk23/sr-chain-core-go/data.BigIntCaster" json:"relayedValue"`
	...
	CallType       github_com_Reshusk23_sr_chain_core_go_data_vm.CallType `protobuf:"varint,13,opt,name=CallType,proto3,casttype=github.com/Reshusk23/sr-chain-core-go/data/vm.CallType" json:"callType"`
...
func (m *SmartContractResult) GetCallType() github_com_Reshusk23_sr_chain_core_go_data_vm.CallType {
	if m != nil {
		return m.CallType
	}
	return 0
...
var fileDescriptor_edc1605de0d3d805 = []byte{
	...
	,
}
	...
	for iNdEx < l {
		...
		case 13:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.CallType |= github_com_Reshusk23_sr_chain_core_go_data_vm.CallType(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
